...
Ở đoạn code trên ta kiểm tra xem $_SESSION['username'] , $_SESSION['password'] có 
tồn tại không, nếu có thì in ra $_SESSION['usernname'] nếu không thì bắt phải đăng nhập 
lại
<?php 
